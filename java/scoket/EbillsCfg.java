...
public class EbillsCfg {
	public static final String EBILLS_MSG_FORMAT = "[{0}][{1}]{2}";
	public static final String LOG_CONFIG_FILE = "log4j.xml";
	public static final String ENV_HOME_DIR = "ebills.home.dir";
	public static final String CONFIG_FILE = "ebills.properties";
	...
	public static String getHomeDir() {
		String hdir = System.getProperty("ebills.home.dir");
		if (null == hdir) {

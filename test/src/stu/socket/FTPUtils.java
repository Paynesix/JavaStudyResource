...
public class FTPUtils {
     ...
     * @param charset 编码
     */
    public FTPUtils(String address, String username, String password, String charset){
    ...
    public void upload(String dir, boolean del, File... files) throws Exception {  
        if (StringUtils.isEmpty(dir) || isEmpty(files)) {  
            return;  
        }  
    ...
    private boolean isEmpty(String...dirs){
    	boolean is  = false;
    	if( dirs != null ){
    		for(String dir : dirs){
    			if( StringUtils.isEmpty(dir) ){
